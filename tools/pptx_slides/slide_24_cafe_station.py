...
from tools.pptx_core import new_slide, add_meta, add_text, add_picture, add_rect, FONT_REGULAR, FONT_MEDIUM, FONT_SEMIBOLD
...
def build(prs, assets_dir):
    ...
    add_text(
        ...
        [
            [
                ("Café Station 1", FONT_MEDIUM, 32, "#fa7317", 1.1),
                ("™", FONT_REGULAR, 16, "#fa7317", 1.1),
            ]
        ],
    )
