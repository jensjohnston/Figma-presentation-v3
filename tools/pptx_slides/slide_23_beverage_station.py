...
from tools.pptx_core import new_slide, add_meta, add_text, add_picture, add_label_with_mark, FONT_REGULAR, FONT_MEDIUM, FONT_SEMIBOLD
...
def build(prs, assets_dir):
    ...
    add_label_with_mark(
        slide, 48, 115, "Beverage Station 1", FONT_MEDIUM, 32, "#f43f5e",
