"""Slide 17 -- Cleone. Figma node 64997:137.

Three-column product page: intro card + mini-stat cards (left), product
photo (center), spec cards (right). No SuperiorOsmosis ring badge appears on
this slide (those nodes exist in the file but are hidden/unused here).
"""
...
def build(prs, assets_dir):
    slide = new_slide(prs)
    add_meta(slide, "Bluewater Purifiers", "17/33")

    a = f"{assets_dir}/slide_17"
